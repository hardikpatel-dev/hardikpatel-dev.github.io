...
const ProfileFrame = ({ name, designation, image }) => {
  return (
    <div
      data-cursor="Hardik Patel"
      className="w-50 h-75  sm:w-70 sm:h-105 bg-white mx-auto p-2 rounded-sm overflow-hidden -rotate-2 shadow-lg transition-transform duration-300 ease-in-out hover:scale-105 hover:rotate-0"
    >
